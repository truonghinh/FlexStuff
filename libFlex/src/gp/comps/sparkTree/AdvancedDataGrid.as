 ...
 */
[Event(name="itemClose", type="gp.comps.sparkTree.TreeEvent")]

/**
 *  Dispatched when a branch is opened or expanded.
 */
[Event(name="itemOpen", type="gp.comps.sparkTree.TreeEvent")]

/**
 *  Dispatched when a branch open or close is initiated.
 */
[Event(name="itemOpening", type="gp.comps.sparkTree.TreeEvent")]
...
public class AdvancedDataGrid extends DataGrid
{
	...
	[Embed("../../../../assets/folder_open_32x32.png")]
	private var folderOpenIcon:Class;
	
	[Embed("../../../../assets/folder_32x32.png")]
